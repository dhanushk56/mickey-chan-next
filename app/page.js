...
const pinkSceneryUrl = "https://www.craiyon.com/en/search/pink-scenery";
  ...
  return (
    <>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="pink-scenery-banner block mx-6 md:mx-16 mt-8 rounded-2xl overflow-hidden"
        aria-label="Explore pink scenery on Craiyon"
      >
        <div className="relative min-h-52 md:min-h-72 flex items-center justify-center px-6 text-center">
          <div className="relative z-10">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-pink-700 mb-3">
              Pink Scenery
            </p>
            <h2 className="font-display text-3xl md:text-5xl font-bold text-black mb-3">
              A softer world awaits
            </h2>
            <p className="text-black/70 max-w-xl mx-auto">
              Explore dreamy pink scenery generated by the community.
            </p>
          </div>
        </div>
      </a>
